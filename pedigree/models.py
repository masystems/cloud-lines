...
class Pedigree(models.Model):
    ...
    parent_father = models.ForeignKey('self', related_name='father', on_delete=models.SET_NULL, blank=True, null=True)
    parent_mother = models.ForeignKey('self', related_name='mother', on_delete=models.SET_NULL, blank=True, null=True)
    breed_group = models.CharField(max_length=255, blank=True, null=True)
