                        ...
                        <span class="mytooltip tooltip-effect-4">
                            ...
                            <span class="tooltip-content clearfix">
                                <span class="tooltip-text2">
                                    <a href='{reverse("pedigree", args=[member.id])}' class="btn btn-outline-primary waves-effect waves-light mx-1 my-1" role="button"><span class="btn-label"><i class="fad fa-mars"></i></span> <strong>Profile</strong></a>
                                    <ul class="list-icons">
